...
- H2 官方文档《Features》(`h2/src/docsrc/html/features.html#feature_list`) — 官方完整特性列表
- H2 官方文档《Security》(`h2/src/docsrc/html/security.html`) — 安全特性完整说明
- H2 官方文档《Tutorial》(`h2/src/docsrc/html/tutorial.html`) — 快速入门和命令行工具指南
