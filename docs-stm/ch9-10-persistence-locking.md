...
└──────────────────────────────────────────────────────────────────┘
```
**图 9-11: 对比 Leaf 与 NonLeaf 节点结构差异**
...
└──────────────────────────────────────────────────┘
```
**图 9-20: 追踪 MVStore 写入路径的事务层与存储层**
...
└──────────────────────────────────────────────────────────────────┘
```
**图 9-21: 对比传统 WAL 与 MVStore 隐式日志**
...
└──────────────────────────────────────────────────────────────────┘
```
**图 9-22: 追踪 MVStore 原子提交流程与崩溃安全保证**
...
└──────────────────────────────────────────────────────────────────┘
```
以下三张图共同呈现 MVStore 持久化机制的三个视角：图 9-28 描绘后台线程调度的时间线，图 9-29 拆解 MVStore 文件的三级层次结构，图 9-30 追踪文件打开与最新 Chunk 定位流程。
...
**图 9-31: 阐释 File Header 双冗余与写入策略**
...
└──────────────────────────────────────────────────────────────────┘
```
**图 9-34: 追踪 MVStore 恢复流程的详细步骤与代码路径**
...
└──────────────────────────────────────────────────────────────────┘
```
**图 9-36: 描绘 VersionedBitSet 恢复状态机**
...
└──────────────────────────────────────────────────────────────────┘
```
**图 10-7: 拆解 VersionedValue 的 opId 编码**
...
└──────────────────────────────────────────────────────────────────┘
```
**图 10-10: 展示 TxDecisionMaker 完整决策树**
...
└──────────────────────────────────────────────────────────────────┘
```
**图 10-13: 追踪 DFS 在 3 个 Session 死锁中的遍历**
...
└──────────────────────────────────────────────────────────────────┘
```
**图 10-16: 对比 TransactionMap 迭代器实现差异**
...
└──────────────────────────────────────────────────────────────────┘
```
**图 10-17: 展示 TransactionMap 迭代器选择决策**
...
└──────────────────────────────────────────────────────────────────┘
```
**图 10-20: 拆解 RootReference 不可变对象结构**
...
└──────────────────────────────────────────────────────────────────┘
```
**图 10-24: 描绘 RootReference 锁状态转换**
...
└──────────────────────────────────────────────────────────────────┘
```
**图 10-29: 对比 SOCKET 锁与 FILE 锁的适用场景**
...
**图 10-36: 汇总 H2 各隔离级别的 ACID 支持情况**
